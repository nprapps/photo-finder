...
Any copyrighted or large binary assets (images, audio, video), should not be added to the Github repository, but rather to the folder in Dropbox corresponding to this project: ``~/Dropbox/nprapps/assets/photo-finder``. This folder is symlinked to ``www/assets`` during the bootstrap process.
